...
const UpdateService = () => {
    ...
    return (
        <div className="w-full grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
            ...
            <input name="name" type="text" defaultValue={service.title} className="input input-bordered input-lg w-full mb-2 max-w-full" />

            <input name="email" type="email" defaultValue={service.description} className="input input-bordered input-lg w-full mb-2 max-w-full" />
